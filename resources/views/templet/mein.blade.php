...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <style>
      ...
      .centered-image {
            ...
            align-items: center;
            height: 400px;  /* Atur tinggi yang diinginkan */
            overflow: hidden;
          }
          .centered-image img {
            transition: transform 0.3s ease; /* Animasi saat gambar di-klik */
          }
          .centered-image img:hover {
            transform: scale(0.85); /* Ubah ukuran gambar saat di-hover */
          }
  ...
  <body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
      <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="/">We Barber</a>
    </header>
          ...
          <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
            <div class="offcanvas-header">
              <h5 class="offcanvas-title" id="sidebarMenuLabel">Company name</h5>
                <a href="">
                <button type="button" class="btn-close" data-bs-dismiss="offcanvas" data-bs-target="#sidebarMenu" aria-label="Close">aaa</button>
                </a>
            </div>
            <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
              ...
              <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-body-secondary text-uppercase">
                <span>Pencukur</span>
                <a class="link-secondary" href="/dashboard/create" aria-label="Add a new report">
              ...
              <ul class="nav flex-column mb-auto">
                @foreach ($posts as $item)
                  <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2" href="/dashboard/{{ $item->nama }}">
