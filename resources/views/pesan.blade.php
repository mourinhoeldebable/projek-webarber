...
{{-- <div class="container">
    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
      <li class="nav-item dropdown" role="presentation">
        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Our Social Media</a>
        <ul class="dropdown-menu">
          <form action="#">
          @foreach ($posts as $post)
          <li>
            <input type="hidden" value="{{ $post->nama }}" name="check">
            <button class="btn btn-warning mb-2" type="submit">{{ $post->nama }}</button>
          </li>
          @endforeach
          @if ($nama > 0)
            <input type="hidden" value="{{ $post->nama }}" name="check">
...
<form action="/info" method="post" enctype="multipart/form-data">
          ...
          <div class="form-floating mb-3">                   
            <input
              ...
              value="{{ old('pelanggan') }}"
            >               
            <label for="pelanggan" class="text-black">Nama</label>
          </div>
          <div class="row g-2 mb-3">
            <div class="col-md">
              <div class="form-floating div1">
                <select class="form-select" id="floatingSelectGrids" name="nama">     
                  <option value="" selected>pilih Beruangmu</option>         
                  @foreach ($posts as $post)                                       
                    <option value="{{ $post->nama }}">{{ $post->nama }}</option>                    
                  @endforeach
                </select>
                <label for="floatingSelectGrids" class="text-black">Pilih Beruang mu!</label>
              </div>
            </div>
            <div class="col-md">
              {{-- @if ($nama > 0) --}}
              <div class="form-floating">
                <select class="form-select" id="floatingSelectGrid" name="jam" id="jam">   
                  <option value="">Pilih Beruangmu terlebih dahulu</option>
                </select>
                <label for="floatingSelectGrid" class="text-black">Tentukan Jam Potong(WIB) {{ $nama }}</label>
              </div>

                  
              {{-- @else
              <div class="col-md bg-white rounded div2 d-flex align-items-center justify-content-center">
                <p class="text-center">pilih Beruangmu Terlebih Dahulu
          ...
          <div class="form-floating mb-3">
            ...
            <label for="email" class="text-black">Email <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope text-secondary" class="text-secondary" viewBox="0 0 16 16">
        ...
        <div class="input-group mb-3">
          ...
          <div class="form-floating">
            <input type="number" class="form-control" id="floatingInputGroup1" placeholder="Username" name="telp" value="{{ old('telp') }}">
            <label for="floatingInputGroup1" class="text-black">No Telp <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
        ...
        <div class="mb-3">
          ...
          <input class="form-control rounded-5" type="file" id="image" name="image" onchange="previewImage()">  
          <img class="img-preview col-sm-5 mt-3" style="">      
        </div>

          <p class="text-light">Baca<!-- Button trigger modal -->
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body ">
                    <p>1. tidak dapat melakukan refund</p>
                    <p>2. datanglah sesuai waktu yang sudah dipesan</p>
                    <p>3. bayar biaya booking sebesar Rp.20.000 pada qris yang tersedia</p>
                    <p>4. happy bear</p>
                    <img src="{{ asset('storage/bukti-bayar/scan.jpg') }}"  class="img-fluid border rounded mx-auto d-block shadow-lg"  alt="Qris Gopay">
                  </div>
